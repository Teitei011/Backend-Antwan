                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('Bora Treinar?', style: TextStyle(fontFamily: 'inter', fontWeight: FontWeight.w700, fontSize: 32, color: Colors.white)),
                      ),
                      Text("Um site para melhorar a si mesmo", style: TextStyle(color: Colors.white)),
                    ],
                  ),
                  Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          child: Text('Inscrever', style: TextStyle(color: AppColor.secondary, fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'inter')),
                          onPressed: () {
                      ...
                      Container(
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            text: 'By joining Bora Treinar?, you agree to our ',
